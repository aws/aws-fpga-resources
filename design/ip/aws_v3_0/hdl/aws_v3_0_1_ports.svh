...
// ============================================================================
  ...
  // Globals
  //----------------------------------------
  input  logic          clk_hbm_ref,      //User clock
  ...
  input  logic   [1:0]  cfg_max_payload,   //Max payload size - 00:128B, 01:256B, 10:512B
  ...
  //-----------------------------------------------------------------------------
  // DDR/HBM Stats interfaces for DDR/HBM controllers in the CL.  This must be hooked up
  // to the sh_ddr.sv for the DDR/HBM interfaces to function.  If the DDR/HBM controller is
