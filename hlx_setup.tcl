...
set_param bd.faas_ipname xilinx.com:ip:aws:3.0
set_param bd.faas_interface xilinx.com:interface:aws_f1_sh1_rtl:1.0
set_param bd.faas_board xilinx.com:f2_cl:1.0
...
if {[info exists shell]} {
   	...
   	send_msg_id "hlx_setup 0-1" ERROR "shell variable is not correct, use small_shell or xdma_shell for the shell variable"
	}
  } else {
    send_msg_id "hlx_setup 0-0" ERROR "shell variable is not found, set shell variable in init.tcl or Vivado_init.tcl to small_shell or xdma_shell"
  }
