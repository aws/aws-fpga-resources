...
add_cells_to_pblock [get_pblocks pblock_CL_SLR2] [get_cells -hierarchical -filter "NAME=~*axi_register_slice_ddr4*slr_slave*"]
...
# Module Mapping
########################################
add_cells_to_pblock [get_pblocks pblock_CL_SLR1] [get_cells -hierarchical -filter "NAME=~*axi_register_slice_hbm*slr_master*"]
add_cells_to_pblock [get_pblocks pblock_CL_SLR1] [get_cells WRAPPER/CL/cl_inst/smartconnect_hbm]
add_cells_to_pblock [get_pblocks pblock_CL_SLR1] [get_cells [list WRAPPER/CL/cl_inst/axi_smc_pcis WRAPPER/CL/cl_inst/smartconnect_ddr4]]
add_cells_to_pblock [get_pblocks pblock_CL_SLR1] [get_cells -hierarchical -filter "NAME=~*axi_register_slice_ddr4*slr_master*"]
...
# Module Mapping
########################################
add_cells_to_pblock [get_pblocks pblock_CL_SLR0] [get_cells -hierarchical -filter "NAME=~*axi_register_slice_hbm*slr_slave*"]
