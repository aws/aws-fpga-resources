...
# Module Mapping
########################################
add_cells_to_pblock [get_pblocks pblock_CL_SLR2] [get_cells [list WRAPPER/CL/cl_inst/axi_smc_pcis WRAPPER/CL/cl_inst/smartconnect_hbm WRAPPER/CL/cl_inst/smartconnect_ddr4]]

add_cells_to_pblock [get_pblocks pblock_CL_SLR2] [get_cells -hierarchical -filter "NAME=~*axi_register_slice_hbm*slr_master*"]
...
# Partial CRs
resize_pblock pblock_CL_SLR1 -add {SLICE_X120Y240:SLICE_X145Y479 \
...
# Module Mapping
########################################
add_cells_to_pblock [get_pblocks pblock_CL_SLR1] [get_cells -hierarchical -filter "NAME=~*axi_register_slice_hbm*slr_middle*"]
