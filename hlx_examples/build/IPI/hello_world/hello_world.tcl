...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net axi_gpio_0_gpio_io_o [get_bd_pins axi_gpio_0/gpio_io_o] [get_bd_pins f2_inst/status_vled]
  connect_bd_net -net f2_inst_clk_main_a0_out [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_smc/aclk] [get_bd_pins f2_inst/clk_main_a0_out] [get_bd_pins f2_inst_axi_periph/ACLK] [get_bd_pins f2_inst_axi_periph/M00_ACLK] [get_bd_pins f2_inst_axi_periph/S00_ACLK]
  connect_bd_net -net f2_inst_rst_main_n_out [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins f2_inst/rst_main_n_out] [get_bd_pins f2_inst_axi_periph/ARESETN] [get_bd_pins f2_inst_axi_periph/M00_ARESETN] [get_bd_pins f2_inst_axi_periph/S00_ARESETN]

  # Create address segments
  create_bd_addr_seg -range 0x00002000 -offset 0xC0000000 [get_bd_addr_spaces f2_inst/M_AXI_PCIS] [get_bd_addr_segs axi_bram_ctrl_0/S_AXI/Mem0] SEG_axi_bram_ctrl_0_Mem0
  create_bd_addr_seg -range 0x00001000 -offset 0x00000000 [get_bd_addr_spaces f2_inst/M_AXI_OCL] [get_bd_addr_segs axi_gpio_0/S_AXI/Reg] SEG_axi_gpio_0_Reg
