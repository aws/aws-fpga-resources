...
add_files -fileset sim_1 [ list \
 ${HDK_SHELL_DIR}/verif/packages/anp_base_pkg.sv\
 ...
 $::aws::make_faas::_nsvars::script_dir/../../verif/fpga_ports.vh\
 $::aws::make_faas::_nsvars::script_dir/../../verif/fpga_signals.vh\
 ${HDK_SHELL_DIR}/verif/tb/sv/tb_type_defines_pkg.sv\
 ${HDK_SHELL_DIR}/verif/models/sh_bfm/axil_bfm.sv\
 ${HDK_SHELL_DIR}/verif/models/sh_bfm/axis_bfm_pkg.sv\
 ${HDK_SHELL_DIR}/verif/models/sh_bfm/axis_bfm.sv\
...
add_files -fileset sim_1 [ list \
 ...
 ${HDK_SHELL_DIR}/verif/models/ddr4_rdimm_wrapper/ddr4_db_dly_dir.sv\
...
set new_inc_var [join [list $define_inc_var "${HDK_SHELL_DIR}/verif/models/ddr4_model ${HDK_SHELL_DIR}/verif/models/sh_bfm ${HDK_SHELL_DESIGN_DIR}/sh_ddr/sim ${HDK_SHELL_DIR}/verif/models/fpga ${HDK_SHELL_DESIGN_DIR}/lib ${HDK_SHELL_DIR}/verif/tb/sv ${HDK_SHELL_DIR}/verif/include ${HDK_SHELL_DIR}/verif/packages ${HDK_SHELL_DESIGN_DIR}/interfaces ${HDK_SHELL_DIR}/shell_stable/hlx/design/lib ${HDK_SHELL_DIR}/../cl/examples/common/design ${HDK_SHELL_DIR}/lib"]]
