...
switch $clock_recipe_hbm {
    "0" {
	set clock_recipe_hbm_sw "H0"
    }
    "1" {
	set clock_recipe_hbm_sw "H1"
    }
    "2" {
	set clock_recipe_hbm_sw "H2"
    }
    "3" {
	set clock_recipe_hbm_sw "H3"
	}
    "4" {
	set clock_recipe_hbm_sw "H4"
    }
    default {
        puts "$clock_recipe_hbm_sw is NOT a valid clock_recipe_hbm."
    }
}
...
#puts $manifest_file "clock_main_a0=$clock_main_a0\n"
...
puts $manifest_file "clock_recipe_hbm=$clock_recipe_hbm_sw\n"
