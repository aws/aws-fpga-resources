...
set vivcmd "vivado -mode batch -source [file normalize [file join $sdp_script_dir make_post_synth_dcp.tcl ]] -tclargs -TOP [get_property top [current_fileset]] -IP_REPO [get_property IP_OUTPUT_REPO [get_project [get_projects]]] -SYNTH_DIR $synth_directory -BD_PATH ${BD_PATH} -USR_XDC [get_files */cl_synth_user.xdc] -AWS_XDC ${AWS_XDC_PATH} -LINK_DCP_PATH $_post_synth_dcp"
