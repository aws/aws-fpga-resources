...
#
# Script generated by Vivado on Thu Jan 23 10:49:07 CST 2025
...
# script info
echo -e "cl_ddr4.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
compile()
{
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"../../../../cl_ip.gen/sources_1/ip/cl_ddr4/ip_1/rtl/map" +incdir+"../../../../cl_ip.gen/sources_1/ip/cl_ddr4/rtl/ip_top" +incdir+"../../../../cl_ip.gen/sources_1/ip/cl_ddr4/rtl/cal" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
  ...
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../cl_ip.gen/sources_1/ip/cl_ddr4/ip_1/rtl/map" +incdir+"../../../../cl_ip.gen/sources_1/ip/cl_ddr4/rtl/ip_top" +incdir+"../../../../cl_ip.gen/sources_1/ip/cl_ddr4/rtl/cal" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
  ...
  vlogan -work blk_mem_gen_v8_4_9 $vlogan_opts +v2k +incdir+"../../../../cl_ip.gen/sources_1/ip/cl_ddr4/ip_1/rtl/map" +incdir+"../../../../cl_ip.gen/sources_1/ip/cl_ddr4/rtl/ip_top" +incdir+"../../../../cl_ip.gen/sources_1/ip/cl_ddr4/rtl/cal" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
