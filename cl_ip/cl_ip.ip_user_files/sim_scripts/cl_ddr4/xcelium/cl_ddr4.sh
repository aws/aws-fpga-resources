...
#
# Script generated by Vivado on Thu Aug 14 14:07:22 UTC 2025
...
# script info
echo -e "cl_ddr4.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
compile()
{
  ...
  xmvlog -work blk_mem_gen_v8_4_11 $xmvlog_opts +incdir+"../../../../cl_ip.gen/sources_1/ip/cl_ddr4/ip_1/rtl/map" +incdir+"../../../../cl_ip.gen/sources_1/ip/cl_ddr4/rtl/ip_top" +incdir+"../../../../cl_ip.gen/sources_1/ip/cl_ddr4/rtl/cal" +incdir+"$XILINX_VIVADO/data/rsb/busdef" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
