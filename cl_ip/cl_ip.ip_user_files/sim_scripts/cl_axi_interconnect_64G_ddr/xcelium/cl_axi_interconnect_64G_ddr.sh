...
design_libs_elab="-libname xilinx_vip -libname xpm -libname generic_baseblocks_v2_1_2 -libname axi_infrastructure_v1_1_0 -libname axi_register_slice_v2_1_33 -libname fifo_generator_v13_2_11 -libname axi_data_fifo_v2_1_32 -libname axi_crossbar_v2_1_34 -libname xil_defaultlib -libname xilinx_vip -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xilinx_vip xpm generic_baseblocks_v2_1_2 axi_infrastructure_v1_1_0 axi_register_slice_v2_1_33 fifo_generator_v13_2_11 axi_data_fifo_v2_1_32 axi_crossbar_v2_1_34 xil_defaultlib)
...
compile()
{
  ...
  xmvlog -work axi_crossbar_v2_1_34 $xmvlog_opts +incdir+"../../../ipstatic/hdl" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
