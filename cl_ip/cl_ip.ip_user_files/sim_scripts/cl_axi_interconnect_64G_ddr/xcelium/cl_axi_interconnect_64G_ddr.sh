...
#
# Script generated by Vivado on Mon Dec 08 20:33:52 UTC 2025
...
#                cl_axi_interconnect_64G_ddr.sh [-rerun]
#                cl_axi_interconnect_64G_ddr.sh [-reset_run]
#                cl_axi_interconnect_64G_ddr.sh [-clean]
...
design_libs_elab="-libname xilinx_vip -libname xpm -libname generic_baseblocks_v2_1_2 -libname axi_infrastructure_v1_1_0 -libname axi_register_slice_v2_1_36 -libname fifo_generator_v13_2_14 -libname axi_data_fifo_v2_1_36 -libname axi_crossbar_v2_1_38 -libname xil_defaultlib -libname xilinx_vip -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xilinx_vip xpm generic_baseblocks_v2_1_2 axi_infrastructure_v1_1_0 axi_register_slice_v2_1_36 fifo_generator_v13_2_14 axi_data_fifo_v2_1_36 axi_crossbar_v2_1_38 xil_defaultlib)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "cl_axi_interconnect_64G_ddr.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
compile()
{
  ...
  xmvlog -work axi_crossbar_v2_1_38 $xmvlog_opts +incdir+"../../../ipstatic/hdl" +incdir+"$XILINX_VIVADO/data/rsb/busdef" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
...
Usage: cl_axi_interconnect_64G_ddr.sh [-rerun]\n\
Usage: cl_axi_interconnect_64G_ddr.sh [-reset_run]\n\
Usage: cl_axi_interconnect_64G_ddr.sh [-clean]\n\
