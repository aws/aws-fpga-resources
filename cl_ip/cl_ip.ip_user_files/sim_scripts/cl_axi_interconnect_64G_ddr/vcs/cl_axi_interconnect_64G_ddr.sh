...
design_libs=(xilinx_vip xpm generic_baseblocks_v2_1_2 axi_infrastructure_v1_1_0 axi_register_slice_v2_1_36 fifo_generator_v13_2_14 axi_data_fifo_v2_1_36 axi_crossbar_v2_1_38 xil_defaultlib)
...
compile()
{
  ...
  vlogan -work axi_crossbar_v2_1_38 $vlogan_opts +v2k +incdir+"../../../ipstatic/hdl" +incdir+"$XILINX_VIVADO/data/rsb/busdef" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
