...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L axi_infrastructure_v1_1_0 -L fifo_generator_v13_2_13 -L axi_clock_converter_v2_1_34 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot axi_clock_converter_0 xil_defaultlib.axi_clock_converter_0 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim axi_clock_converter_0 -key {Behavioral:sim_1:Functional:axi_clock_converter_0} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_2e02.protoinst" -protoinst "protoinst_files/bd_a493.protoinst" -protoinst "protoinst_files/bd_9c5e.protoinst" -protoinst "protoinst_files/bd_c5ad.protoinst" -protoinst "protoinst_files/bd_1535.protoinst" -log simulate.log
}
