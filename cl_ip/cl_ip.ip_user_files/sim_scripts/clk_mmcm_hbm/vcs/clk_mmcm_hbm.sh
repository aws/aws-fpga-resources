...
#
# Script generated by Vivado on Mon Dec 08 20:28:16 UTC 2025
...
#                clk_mmcm_hbm.sh [-rerun]
#                clk_mmcm_hbm.sh [-reset_run]
#                clk_mmcm_hbm.sh [-clean]
...
# script info
echo -e "clk_mmcm_hbm.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
compile()
{
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"../../../ipstatic" +incdir+"$XILINX_VIVADO/data/rsb/busdef" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
  ...
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../ipstatic" +incdir+"$XILINX_VIVADO/data/rsb/busdef" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../ipstatic" +incdir+"$XILINX_VIVADO/data/rsb/busdef" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
...
Usage: clk_mmcm_hbm.sh [-rerun]\n\
Usage: clk_mmcm_hbm.sh [-reset_run]\n\
Usage: clk_mmcm_hbm.sh [-clean]\n\
