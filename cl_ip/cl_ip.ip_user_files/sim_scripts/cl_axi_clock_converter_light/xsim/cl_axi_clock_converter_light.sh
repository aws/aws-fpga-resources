...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L axi_infrastructure_v1_1_0 -L fifo_generator_v13_2_14 -L axi_clock_converter_v2_1_35 -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot cl_axi_clock_converter_light xil_defaultlib.cl_axi_clock_converter_light xil_defaultlib.glbl -log elaborate.log
}
