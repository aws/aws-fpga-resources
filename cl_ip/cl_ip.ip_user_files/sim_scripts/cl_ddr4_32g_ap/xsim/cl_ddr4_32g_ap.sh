...
# set xvlog options
xvlog_opts="--incr --relax  -L uvm -L axi_vip_v1_1_19 -L smartconnect_v1_0 -L hbm_v1_0_16 -L xdma_v4_1_31 -L xilinx_vip"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L microblaze_v11_0_14 -L lib_cdc_v1_0_3 -L proc_sys_reset_v5_0_16 -L lmb_v10_v3_0_14 -L lmb_bram_if_cntlr_v4_0_25 -L blk_mem_gen_v8_4_9 -L iomodule_v3_1_11 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot cl_ddr4_32g_ap xil_defaultlib.cl_ddr4_32g_ap xil_defaultlib.glbl -log elaborate.log
}
