...
# set xvlog options
xvlog_opts="--incr --relax  -L uvm -L hbm_v1_0_17"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L microblaze_v11_0_15 -L proc_sys_reset_v5_0_17 -L lmb_v10_v3_0_15 -L lmb_bram_if_cntlr_v4_0_26 -L blk_mem_gen_v8_4_11 -L iomodule_v3_1_12 -L uvm -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot cl_ddr4_32g_ap xil_defaultlib.cl_ddr4_32g_ap xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim cl_ddr4_32g_ap -key {Behavioral:sim_1:Functional:cl_ddr4_32g_ap} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_2e02.protoinst" -protoinst "protoinst_files/bd_a493.protoinst" -protoinst "protoinst_files/bd_9c5e.protoinst" -protoinst "protoinst_files/bd_c5ad.protoinst" -protoinst "protoinst_files/bd_1535.protoinst" -log simulate.log
}
