...
design_libs=(xilinx_vip xpm microblaze_v11_0_16 xil_defaultlib proc_sys_reset_v5_0_17 lmb_v10_v3_0_16 lmb_bram_if_cntlr_v4_0_27 blk_mem_gen_v8_4_12 iomodule_v3_1_13)
...
compile()
{
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"../../../../cl_ip.gen/sources_1/ip/cl_ddr4_32g_ap/ip_1/rtl/map" +incdir+"../../../../cl_ip.gen/sources_1/ip/cl_ddr4_32g_ap/rtl/ip_top" +incdir+"../../../../cl_ip.gen/sources_1/ip/cl_ddr4_32g_ap/rtl/cal" +incdir+"$XILINX_VIVADO/data/rsb/busdef" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
  ...
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../cl_ip.gen/sources_1/ip/cl_ddr4_32g_ap/ip_1/rtl/map" +incdir+"../../../../cl_ip.gen/sources_1/ip/cl_ddr4_32g_ap/rtl/ip_top" +incdir+"../../../../cl_ip.gen/sources_1/ip/cl_ddr4_32g_ap/rtl/cal" +incdir+"$XILINX_VIVADO/data/rsb/busdef" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
  ...
  vlogan -work blk_mem_gen_v8_4_12 $vlogan_opts +v2k +incdir+"../../../../cl_ip.gen/sources_1/ip/cl_ddr4_32g_ap/ip_1/rtl/map" +incdir+"../../../../cl_ip.gen/sources_1/ip/cl_ddr4_32g_ap/rtl/ip_top" +incdir+"../../../../cl_ip.gen/sources_1/ip/cl_ddr4_32g_ap/rtl/cal" +incdir+"$XILINX_VIVADO/data/rsb/busdef" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
  "../../../ipstatic/simulation/blk_mem_gen_v8_4.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../cl_ip.gen/sources_1/ip/cl_ddr4_32g_ap/ip_1/rtl/map" +incdir+"../../../../cl_ip.gen/sources_1/ip/cl_ddr4_32g_ap/rtl/ip_top" +incdir+"../../../../cl_ip.gen/sources_1/ip/cl_ddr4_32g_ap/rtl/cal" +incdir+"$XILINX_VIVADO/data/rsb/busdef" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts -sverilog +incdir+"../../../../cl_ip.gen/sources_1/ip/cl_ddr4_32g_ap/ip_1/rtl/map" +incdir+"../../../../cl_ip.gen/sources_1/ip/cl_ddr4_32g_ap/rtl/ip_top" +incdir+"../../../../cl_ip.gen/sources_1/ip/cl_ddr4_32g_ap/rtl/cal" +incdir+"$XILINX_VIVADO/data/rsb/busdef" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
