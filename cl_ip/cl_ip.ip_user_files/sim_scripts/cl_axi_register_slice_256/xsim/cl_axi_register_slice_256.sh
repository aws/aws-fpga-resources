...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L axi_infrastructure_v1_1_0 -L axi_register_slice_v2_1_36 -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot cl_axi_register_slice_256 xil_defaultlib.cl_axi_register_slice_256 xil_defaultlib.glbl -log elaborate.log
}
