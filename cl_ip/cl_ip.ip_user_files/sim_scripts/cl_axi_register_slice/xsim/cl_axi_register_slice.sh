...
#
# Script generated by Vivado on Thu Jan 23 10:47:33 CST 2025
...
# script info
echo -e "cl_axi_register_slice.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L axi_infrastructure_v1_1_0 -L axi_register_slice_v2_1_33 -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot cl_axi_register_slice xil_defaultlib.cl_axi_register_slice xil_defaultlib.glbl -log elaborate.log
}
