...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L axi_infrastructure_v1_1_0 -L fifo_generator_v13_2_13 -L axi_clock_converter_v2_1_34 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot cl_axi_clock_converter xil_defaultlib.cl_axi_clock_converter xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim cl_axi_clock_converter -key {Behavioral:sim_1:Functional:cl_axi_clock_converter} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_2e02.protoinst" -protoinst "protoinst_files/bd_a493.protoinst" -protoinst "protoinst_files/bd_9c5e.protoinst" -protoinst "protoinst_files/bd_c5ad.protoinst" -protoinst "protoinst_files/bd_1535.protoinst" -log simulate.log
}
