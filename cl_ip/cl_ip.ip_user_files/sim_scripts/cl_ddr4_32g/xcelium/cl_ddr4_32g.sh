...
#
# Script generated by Vivado on Mon Dec 08 20:31:35 UTC 2025
...
#                cl_ddr4_32g.sh [-rerun]
#                cl_ddr4_32g.sh [-reset_run]
#                cl_ddr4_32g.sh [-clean]
...
# script info
echo -e "cl_ddr4_32g.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
compile()
{
  xmvlog -work xilinx_vip $xmvlog_opts -sv +incdir+"../../../../cl_ip.gen/sources_1/ip/cl_ddr4_32g/ip_1/rtl/map" +incdir+"../../../../cl_ip.gen/sources_1/ip/cl_ddr4_32g/rtl/ip_top" +incdir+"../../../../cl_ip.gen/sources_1/ip/cl_ddr4_32g/rtl/cal" +incdir+"$XILINX_VIVADO/data/rsb/busdef" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
  ...
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../cl_ip.gen/sources_1/ip/cl_ddr4_32g/ip_1/rtl/map" +incdir+"../../../../cl_ip.gen/sources_1/ip/cl_ddr4_32g/rtl/ip_top" +incdir+"../../../../cl_ip.gen/sources_1/ip/cl_ddr4_32g/rtl/cal" +incdir+"$XILINX_VIVADO/data/rsb/busdef" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
  ...
  xmvlog -work blk_mem_gen_v8_4_12 $xmvlog_opts +incdir+"../../../../cl_ip.gen/sources_1/ip/cl_ddr4_32g/ip_1/rtl/map" +incdir+"../../../../cl_ip.gen/sources_1/ip/cl_ddr4_32g/rtl/ip_top" +incdir+"../../../../cl_ip.gen/sources_1/ip/cl_ddr4_32g/rtl/cal" +incdir+"$XILINX_VIVADO/data/rsb/busdef" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
  "../../../ipstatic/simulation/blk_mem_gen_v8_4.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../cl_ip.gen/sources_1/ip/cl_ddr4_32g/ip_1/rtl/map" +incdir+"../../../../cl_ip.gen/sources_1/ip/cl_ddr4_32g/rtl/ip_top" +incdir+"../../../../cl_ip.gen/sources_1/ip/cl_ddr4_32g/rtl/cal" +incdir+"$XILINX_VIVADO/data/rsb/busdef" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts -sv +incdir+"../../../../cl_ip.gen/sources_1/ip/cl_ddr4_32g/ip_1/rtl/map" +incdir+"../../../../cl_ip.gen/sources_1/ip/cl_ddr4_32g/rtl/ip_top" +incdir+"../../../../cl_ip.gen/sources_1/ip/cl_ddr4_32g/rtl/cal" +incdir+"$XILINX_VIVADO/data/rsb/busdef" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
...
Usage: cl_ddr4_32g.sh [-rerun]\n\
Usage: cl_ddr4_32g.sh [-reset_run]\n\
Usage: cl_ddr4_32g.sh [-clean]\n\
