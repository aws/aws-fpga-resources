...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L xsdbm_v3_0_4 -L lut_buffer_v2_0_1 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot cl_debug_bridge xil_defaultlib.cl_debug_bridge xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim cl_debug_bridge -key {Behavioral:sim_1:Functional:cl_debug_bridge} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_2e02.protoinst" -protoinst "protoinst_files/bd_a493.protoinst" -protoinst "protoinst_files/bd_9c5e.protoinst" -protoinst "protoinst_files/bd_c5ad.protoinst" -protoinst "protoinst_files/bd_1535.protoinst" -log simulate.log
}
