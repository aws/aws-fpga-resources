...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L xsdbm_v3_0_3 -L lut_buffer_v2_0_1 -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot cl_debug_bridge xil_defaultlib.cl_debug_bridge xil_defaultlib.glbl -log elaborate.log
}
