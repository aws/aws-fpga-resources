...
#
# Script generated by Vivado on Thu Jan 23 10:50:27 CST 2025
...
design_libs=(xilinx_vip xpm xsdbm_v3_0_3 xil_defaultlib lut_buffer_v2_0_1)

# simulation root library directory
sim_lib_dir="vcs_lib"

# script info
echo -e "cl_debug_bridge.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
compile()
{
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"../../../ipstatic/hdl/verilog" +incdir+"../../../../cl_ip.gen/sources_1/ip/cl_debug_bridge/bd_0/ip/ip_0/hdl/verilog" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
  ...
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../ipstatic/hdl/verilog" +incdir+"../../../../cl_ip.gen/sources_1/ip/cl_debug_bridge/bd_0/ip/ip_0/hdl/verilog" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
  ...
  vlogan -work xsdbm_v3_0_3 $vlogan_opts +v2k +incdir+"../../../ipstatic/hdl/verilog" +incdir+"../../../../cl_ip.gen/sources_1/ip/cl_debug_bridge/bd_0/ip/ip_0/hdl/verilog" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
  ...
  vlogan -work lut_buffer_v2_0_1 $vlogan_opts +v2k +incdir+"../../../ipstatic/hdl/verilog" +incdir+"../../../../cl_ip.gen/sources_1/ip/cl_debug_bridge/bd_0/ip/ip_0/hdl/verilog" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
