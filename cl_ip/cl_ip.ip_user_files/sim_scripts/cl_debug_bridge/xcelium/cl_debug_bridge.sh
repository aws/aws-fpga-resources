...
design_libs_elab="-libname xilinx_vip -libname xpm -libname xsdbm_v3_0_3 -libname xil_defaultlib -libname lut_buffer_v2_0_1 -libname xilinx_vip -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xilinx_vip xpm xsdbm_v3_0_3 xil_defaultlib lut_buffer_v2_0_1)
...
compile()
{
  ...
  xmvlog -work xsdbm_v3_0_3 $xmvlog_opts +incdir+"../../../ipstatic/hdl/verilog" +incdir+"../../../../cl_ip.gen/sources_1/ip/cl_debug_bridge/bd_0/ip/ip_0/hdl/verilog" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
