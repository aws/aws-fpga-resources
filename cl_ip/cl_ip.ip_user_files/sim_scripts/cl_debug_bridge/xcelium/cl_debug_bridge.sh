...
#
# Script generated by Vivado on Mon Dec 08 20:30:15 UTC 2025
...
#                cl_debug_bridge.sh [-rerun]
#                cl_debug_bridge.sh [-reset_run]
#                cl_debug_bridge.sh [-clean]
...
design_libs_elab="-libname xilinx_vip -libname xpm -libname xsdbm_v3_0_5 -libname xil_defaultlib -libname lut_buffer_v2_0_1 -libname xilinx_vip -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xilinx_vip xpm xsdbm_v3_0_5 xil_defaultlib lut_buffer_v2_0_1)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "cl_debug_bridge.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
compile()
{
  xmvlog -work xilinx_vip $xmvlog_opts -sv +incdir+"../../../ipstatic/hdl/verilog" +incdir+"$XILINX_VIVADO/data/rsb/busdef" +incdir+"../../../../cl_ip.gen/sources_1/ip/cl_debug_bridge/bd_0/ip/ip_0/hdl/verilog" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
  ...
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../ipstatic/hdl/verilog" +incdir+"$XILINX_VIVADO/data/rsb/busdef" +incdir+"../../../../cl_ip.gen/sources_1/ip/cl_debug_bridge/bd_0/ip/ip_0/hdl/verilog" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
  ...
  xmvlog -work xsdbm_v3_0_5 $xmvlog_opts +incdir+"../../../ipstatic/hdl/verilog" +incdir+"$XILINX_VIVADO/data/rsb/busdef" +incdir+"../../../../cl_ip.gen/sources_1/ip/cl_debug_bridge/bd_0/ip/ip_0/hdl/verilog" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
  "../../../ipstatic/hdl/xsdbm_v3_0_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../ipstatic/hdl/verilog" +incdir+"$XILINX_VIVADO/data/rsb/busdef" +incdir+"../../../../cl_ip.gen/sources_1/ip/cl_debug_bridge/bd_0/ip/ip_0/hdl/verilog" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
  "../../../../cl_ip.gen/sources_1/ip/cl_debug_bridge/bd_0/ip/ip_0/sim/bd_a493_xsdbm_0.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work lut_buffer_v2_0_1 $xmvlog_opts +incdir+"../../../ipstatic/hdl/verilog" +incdir+"$XILINX_VIVADO/data/rsb/busdef" +incdir+"../../../../cl_ip.gen/sources_1/ip/cl_debug_bridge/bd_0/ip/ip_0/hdl/verilog" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
...
Usage: cl_debug_bridge.sh [-rerun]\n\
Usage: cl_debug_bridge.sh [-reset_run]\n\
Usage: cl_debug_bridge.sh [-clean]\n\
