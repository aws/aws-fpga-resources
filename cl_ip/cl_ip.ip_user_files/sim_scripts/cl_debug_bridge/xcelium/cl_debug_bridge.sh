...
#
# Script generated by Vivado on Thu Aug 14 14:09:19 UTC 2025
...
design_libs_elab="-libname xilinx_vip -libname xpm -libname xsdbm_v3_0_4 -libname xil_defaultlib -libname lut_buffer_v2_0_1 -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xilinx_vip xpm xsdbm_v3_0_4 xil_defaultlib lut_buffer_v2_0_1)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "cl_debug_bridge.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
compile()
{
  ...
  xmvlog -work xsdbm_v3_0_4 $xmvlog_opts +incdir+"../../../ipstatic/hdl/verilog" +incdir+"$XILINX_VIVADO/data/rsb/busdef" +incdir+"../../../../cl_ip.gen/sources_1/ip/cl_debug_bridge/bd_0/ip/ip_0/hdl/verilog" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
