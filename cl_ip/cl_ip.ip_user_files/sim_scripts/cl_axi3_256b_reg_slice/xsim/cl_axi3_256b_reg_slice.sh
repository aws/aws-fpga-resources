...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L axi_infrastructure_v1_1_0 -L axi_register_slice_v2_1_35 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot cl_axi3_256b_reg_slice xil_defaultlib.cl_axi3_256b_reg_slice xil_defaultlib.glbl -log elaborate.log
}
