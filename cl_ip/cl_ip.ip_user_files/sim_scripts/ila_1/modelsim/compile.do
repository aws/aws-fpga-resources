...
vlog -work xpm -64 -incr -mfcu  -sv -L smartconnect_v1_0 -L axi_vip_v1_1_22 -L xilinx_vip "+incdir+$XILINX_VIVADO/data/rsb/busdef" "+incdir+../../../../cl_ip.gen/sources_1/ip/ila_1/hdl/verilog" "+incdir+$XILINX_VIVADO/data/xilinx_vip/include" \
...
vlog -work xil_defaultlib -64 -incr -mfcu  "+incdir+$XILINX_VIVADO/data/rsb/busdef" "+incdir+../../../../cl_ip.gen/sources_1/ip/ila_1/hdl/verilog" "+incdir+$XILINX_VIVADO/data/xilinx_vip/include" \
