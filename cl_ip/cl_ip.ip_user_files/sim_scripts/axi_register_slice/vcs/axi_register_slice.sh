...
#
# Script generated by Vivado on Thu Jan 23 10:45:16 CST 2025
...
design_libs=(xilinx_vip xpm axi_infrastructure_v1_1_0 axi_register_slice_v2_1_33 xil_defaultlib)

# simulation root library directory
sim_lib_dir="vcs_lib"

# script info
echo -e "axi_register_slice.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
compile()
{
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"../../../../cl_ip.gen/sources_1/ip/axi_register_slice/hdl" +incdir+"../../../../cl_ip.gen/sources_1/ip/cl_axi_register_slice/hdl" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
  ...
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../cl_ip.gen/sources_1/ip/axi_register_slice/hdl" +incdir+"../../../../cl_ip.gen/sources_1/ip/cl_axi_register_slice/hdl" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
  ...
  vlogan -work axi_infrastructure_v1_1_0 $vlogan_opts +v2k +incdir+"../../../../cl_ip.gen/sources_1/ip/axi_register_slice/hdl" +incdir+"../../../../cl_ip.gen/sources_1/ip/cl_axi_register_slice/hdl" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
  "../../../ipstatic/hdl/axi_infrastructure_v1_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work axi_register_slice_v2_1_33 $vlogan_opts +v2k +incdir+"../../../../cl_ip.gen/sources_1/ip/axi_register_slice/hdl" +incdir+"../../../../cl_ip.gen/sources_1/ip/cl_axi_register_slice/hdl" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
