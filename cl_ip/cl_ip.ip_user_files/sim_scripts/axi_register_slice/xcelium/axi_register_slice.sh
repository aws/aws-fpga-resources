...
compile()
{
  ...
  xmvlog -work axi_register_slice_v2_1_33 $xmvlog_opts +incdir+"../../../../cl_ip.gen/sources_1/ip/axi_register_slice/hdl" +incdir+"../../../../cl_ip.gen/sources_1/ip/cl_axi_register_slice/hdl" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
