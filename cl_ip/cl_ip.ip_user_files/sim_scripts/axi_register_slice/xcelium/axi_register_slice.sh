...
#
# Script generated by Vivado on Thu Aug 14 14:07:47 UTC 2025
...
# script info
echo -e "axi_register_slice.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
compile()
{
  ...
  xmvlog -work axi_register_slice_v2_1_35 $xmvlog_opts +incdir+"$XILINX_VIVADO/data/rsb/busdef" +incdir+"../../../../cl_ip.gen/sources_1/ip/axi_register_slice/hdl" +incdir+"../../../../cl_ip.gen/sources_1/ip/cl_axi_register_slice/hdl" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
