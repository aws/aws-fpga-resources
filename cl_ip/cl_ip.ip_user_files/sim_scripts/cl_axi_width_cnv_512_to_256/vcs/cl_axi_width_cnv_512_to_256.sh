...
design_libs=(xilinx_vip xpm generic_baseblocks_v2_1_2 fifo_generator_v13_2_14 axi_data_fifo_v2_1_36 axi_infrastructure_v1_1_0 axi_register_slice_v2_1_36 axi_protocol_converter_v2_1_37 axi_clock_converter_v2_1_35 blk_mem_gen_v8_4_12 axi_dwidth_converter_v2_1_37 xil_defaultlib)
...
compile()
{
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"../../../ipstatic/hdl" +incdir+"$XILINX_VIVADO/data/rsb/busdef" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
  ...
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../ipstatic/hdl" +incdir+"$XILINX_VIVADO/data/rsb/busdef" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
  ...
  vlogan -work generic_baseblocks_v2_1_2 $vlogan_opts +v2k +incdir+"../../../ipstatic/hdl" +incdir+"$XILINX_VIVADO/data/rsb/busdef" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
  "../../../ipstatic/hdl/generic_baseblocks_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work fifo_generator_v13_2_14 $vlogan_opts +v2k +incdir+"../../../ipstatic/hdl" +incdir+"$XILINX_VIVADO/data/rsb/busdef" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
  ...
  vlogan -work axi_data_fifo_v2_1_36 $vlogan_opts +v2k +incdir+"../../../ipstatic/hdl" +incdir+"$XILINX_VIVADO/data/rsb/busdef" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
  "../../../ipstatic/hdl/axi_data_fifo_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work axi_infrastructure_v1_1_0 $vlogan_opts +v2k +incdir+"../../../ipstatic/hdl" +incdir+"$XILINX_VIVADO/data/rsb/busdef" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
  "../../../ipstatic/hdl/axi_infrastructure_v1_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work axi_register_slice_v2_1_36 $vlogan_opts +v2k +incdir+"../../../ipstatic/hdl" +incdir+"$XILINX_VIVADO/data/rsb/busdef" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
  "../../../ipstatic/hdl/axi_register_slice_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work axi_protocol_converter_v2_1_37 $vlogan_opts +v2k +incdir+"../../../ipstatic/hdl" +incdir+"$XILINX_VIVADO/data/rsb/busdef" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
  "../../../ipstatic/hdl/axi_protocol_converter_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work axi_clock_converter_v2_1_35 $vlogan_opts +v2k +incdir+"../../../ipstatic/hdl" +incdir+"$XILINX_VIVADO/data/rsb/busdef" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
  "../../../ipstatic/hdl/axi_clock_converter_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work blk_mem_gen_v8_4_12 $vlogan_opts +v2k +incdir+"../../../ipstatic/hdl" +incdir+"$XILINX_VIVADO/data/rsb/busdef" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
  "../../../ipstatic/simulation/blk_mem_gen_v8_4.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work axi_dwidth_converter_v2_1_37 $vlogan_opts +v2k +incdir+"../../../ipstatic/hdl" +incdir+"$XILINX_VIVADO/data/rsb/busdef" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
  "../../../ipstatic/hdl/axi_dwidth_converter_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../ipstatic/hdl" +incdir+"$XILINX_VIVADO/data/rsb/busdef" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
