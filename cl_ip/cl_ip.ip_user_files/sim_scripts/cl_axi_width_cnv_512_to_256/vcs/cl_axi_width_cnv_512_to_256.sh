...
#
# Script generated by Vivado on Thu Jan 23 10:48:19 CST 2025
...
design_libs=(xilinx_vip xpm generic_baseblocks_v2_1_2 fifo_generator_v13_2_11 axi_data_fifo_v2_1_32 axi_infrastructure_v1_1_0 axi_register_slice_v2_1_33 axi_protocol_converter_v2_1_33 axi_clock_converter_v2_1_32 blk_mem_gen_v8_4_9 axi_dwidth_converter_v2_1_33 xil_defaultlib)

# simulation root library directory
sim_lib_dir="vcs_lib"

# script info
echo -e "cl_axi_width_cnv_512_to_256.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
compile()
{
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"../../../ipstatic/hdl" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
  ...
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../ipstatic/hdl" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
  ...
  vlogan -work generic_baseblocks_v2_1_2 $vlogan_opts +v2k +incdir+"../../../ipstatic/hdl" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
  "../../../ipstatic/hdl/generic_baseblocks_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work fifo_generator_v13_2_11 $vlogan_opts +v2k +incdir+"../../../ipstatic/hdl" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
  ...
  vlogan -work axi_data_fifo_v2_1_32 $vlogan_opts +v2k +incdir+"../../../ipstatic/hdl" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
  "../../../ipstatic/hdl/axi_data_fifo_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work axi_infrastructure_v1_1_0 $vlogan_opts +v2k +incdir+"../../../ipstatic/hdl" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
  "../../../ipstatic/hdl/axi_infrastructure_v1_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work axi_register_slice_v2_1_33 $vlogan_opts +v2k +incdir+"../../../ipstatic/hdl" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
  "../../../ipstatic/hdl/axi_register_slice_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work axi_protocol_converter_v2_1_33 $vlogan_opts +v2k +incdir+"../../../ipstatic/hdl" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
  "../../../ipstatic/hdl/axi_protocol_converter_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work axi_clock_converter_v2_1_32 $vlogan_opts +v2k +incdir+"../../../ipstatic/hdl" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
  "../../../ipstatic/hdl/axi_clock_converter_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work blk_mem_gen_v8_4_9 $vlogan_opts +v2k +incdir+"../../../ipstatic/hdl" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
  "../../../ipstatic/simulation/blk_mem_gen_v8_4.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work axi_dwidth_converter_v2_1_33 $vlogan_opts +v2k +incdir+"../../../ipstatic/hdl" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
