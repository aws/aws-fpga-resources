...
#
# Script generated by Vivado on Thu Aug 14 14:08:51 UTC 2025
...
design_libs_elab="-libname xilinx_vip -libname xpm -libname generic_baseblocks_v2_1_2 -libname fifo_generator_v13_2_13 -libname axi_data_fifo_v2_1_35 -libname axi_infrastructure_v1_1_0 -libname axi_register_slice_v2_1_35 -libname axi_protocol_converter_v2_1_36 -libname axi_clock_converter_v2_1_34 -libname blk_mem_gen_v8_4_11 -libname axi_dwidth_converter_v2_1_36 -libname xil_defaultlib -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xilinx_vip xpm generic_baseblocks_v2_1_2 fifo_generator_v13_2_13 axi_data_fifo_v2_1_35 axi_infrastructure_v1_1_0 axi_register_slice_v2_1_35 axi_protocol_converter_v2_1_36 axi_clock_converter_v2_1_34 blk_mem_gen_v8_4_11 axi_dwidth_converter_v2_1_36 xil_defaultlib)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "cl_axi_width_cnv_512_to_256.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
compile()
{
  ...
  xmvlog -work fifo_generator_v13_2_13 $xmvlog_opts +incdir+"../../../ipstatic/hdl" +incdir+"$XILINX_VIVADO/data/rsb/busdef" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
  ...
  xmvlog -work axi_data_fifo_v2_1_35 $xmvlog_opts +incdir+"../../../ipstatic/hdl" +incdir+"$XILINX_VIVADO/data/rsb/busdef" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
  ...
  xmvlog -work axi_register_slice_v2_1_35 $xmvlog_opts +incdir+"../../../ipstatic/hdl" +incdir+"$XILINX_VIVADO/data/rsb/busdef" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
  "../../../ipstatic/hdl/axi_register_slice_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_protocol_converter_v2_1_36 $xmvlog_opts +incdir+"../../../ipstatic/hdl" +incdir+"$XILINX_VIVADO/data/rsb/busdef" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
  "../../../ipstatic/hdl/axi_protocol_converter_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_clock_converter_v2_1_34 $xmvlog_opts +incdir+"../../../ipstatic/hdl" +incdir+"$XILINX_VIVADO/data/rsb/busdef" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
  "../../../ipstatic/hdl/axi_clock_converter_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work blk_mem_gen_v8_4_11 $xmvlog_opts +incdir+"../../../ipstatic/hdl" +incdir+"$XILINX_VIVADO/data/rsb/busdef" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
  "../../../ipstatic/simulation/blk_mem_gen_v8_4.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_dwidth_converter_v2_1_36 $xmvlog_opts +incdir+"../../../ipstatic/hdl" +incdir+"$XILINX_VIVADO/data/rsb/busdef" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
