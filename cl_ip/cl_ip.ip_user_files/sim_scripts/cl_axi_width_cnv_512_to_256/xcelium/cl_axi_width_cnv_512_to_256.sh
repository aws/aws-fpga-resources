...
design_libs_elab="-libname xilinx_vip -libname xpm -libname generic_baseblocks_v2_1_2 -libname fifo_generator_v13_2_11 -libname axi_data_fifo_v2_1_32 -libname axi_infrastructure_v1_1_0 -libname axi_register_slice_v2_1_33 -libname axi_protocol_converter_v2_1_33 -libname axi_clock_converter_v2_1_32 -libname blk_mem_gen_v8_4_9 -libname axi_dwidth_converter_v2_1_33 -libname xil_defaultlib -libname xilinx_vip -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xilinx_vip xpm generic_baseblocks_v2_1_2 fifo_generator_v13_2_11 axi_data_fifo_v2_1_32 axi_infrastructure_v1_1_0 axi_register_slice_v2_1_33 axi_protocol_converter_v2_1_33 axi_clock_converter_v2_1_32 blk_mem_gen_v8_4_9 axi_dwidth_converter_v2_1_33 xil_defaultlib)
...
compile()
{
  ...
  xmvlog -work fifo_generator_v13_2_11 $xmvlog_opts +incdir+"../../../ipstatic/hdl" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
  ...
  xmvlog -work axi_data_fifo_v2_1_32 $xmvlog_opts +incdir+"../../../ipstatic/hdl" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
  ...
  xmvlog -work axi_register_slice_v2_1_33 $xmvlog_opts +incdir+"../../../ipstatic/hdl" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
  "../../../ipstatic/hdl/axi_register_slice_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_protocol_converter_v2_1_33 $xmvlog_opts +incdir+"../../../ipstatic/hdl" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
  "../../../ipstatic/hdl/axi_protocol_converter_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_clock_converter_v2_1_32 $xmvlog_opts +incdir+"../../../ipstatic/hdl" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
  "../../../ipstatic/hdl/axi_clock_converter_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work blk_mem_gen_v8_4_9 $xmvlog_opts +incdir+"../../../ipstatic/hdl" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
  "../../../ipstatic/simulation/blk_mem_gen_v8_4.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_dwidth_converter_v2_1_33 $xmvlog_opts +incdir+"../../../ipstatic/hdl" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
