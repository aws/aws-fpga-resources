...
# set xvlog options
xvlog_opts="--incr --relax  -L hbm_v1_0_17"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L generic_baseblocks_v2_1_2 -L fifo_generator_v13_2_13 -L axi_data_fifo_v2_1_35 -L axi_infrastructure_v1_1_0 -L axi_register_slice_v2_1_35 -L axi_protocol_converter_v2_1_36 -L axi_clock_converter_v2_1_34 -L blk_mem_gen_v8_4_11 -L axi_dwidth_converter_v2_1_36 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot cl_axi_width_cnv_512_to_256 xil_defaultlib.cl_axi_width_cnv_512_to_256 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim cl_axi_width_cnv_512_to_256 -key {Behavioral:sim_1:Functional:cl_axi_width_cnv_512_to_256} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_2e02.protoinst" -protoinst "protoinst_files/bd_a493.protoinst" -protoinst "protoinst_files/bd_9c5e.protoinst" -protoinst "protoinst_files/bd_c5ad.protoinst" -protoinst "protoinst_files/bd_1535.protoinst" -log simulate.log
}
