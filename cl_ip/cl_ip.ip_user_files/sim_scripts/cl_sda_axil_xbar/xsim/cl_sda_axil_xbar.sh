...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L generic_baseblocks_v2_1_2 -L axi_infrastructure_v1_1_0 -L axi_register_slice_v2_1_36 -L fifo_generator_v13_2_14 -L axi_data_fifo_v2_1_36 -L axi_crossbar_v2_1_38 -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot cl_sda_axil_xbar xil_defaultlib.cl_sda_axil_xbar xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim cl_sda_axil_xbar -key {Behavioral:sim_1:Functional:cl_sda_axil_xbar} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_6722.protoinst" -protoinst "protoinst_files/cl_axi_sc_1x1.protoinst" -protoinst "protoinst_files/bd_1096.protoinst" -protoinst "protoinst_files/cl_axi_sc_2x2.protoinst" -log simulate.log
}
