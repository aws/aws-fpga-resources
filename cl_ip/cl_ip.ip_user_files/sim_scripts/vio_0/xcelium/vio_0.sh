...
#
# Script generated by Vivado on Thu Aug 14 14:10:30 UTC 2025
...
design_libs_elab="-libname xilinx_vip -libname xpm -libname xil_defaultlib -libname unisims_ver -libname unimacro_ver -libname secureip"
...
# script info
echo -e "vio_0.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
compile()
{
  xmvlog -work xilinx_vip $xmvlog_opts -sv +incdir+"$XILINX_VIVADO/data/rsb/busdef" +incdir+"../../../../cl_ip.gen/sources_1/ip/vio_0/hdl/verilog" +incdir+"../../../../cl_ip.gen/sources_1/ip/vio_0/hdl" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
  ...
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"$XILINX_VIVADO/data/rsb/busdef" +incdir+"../../../../cl_ip.gen/sources_1/ip/vio_0/hdl/verilog" +incdir+"../../../../cl_ip.gen/sources_1/ip/vio_0/hdl" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"$XILINX_VIVADO/data/rsb/busdef" +incdir+"../../../../cl_ip.gen/sources_1/ip/vio_0/hdl/verilog" +incdir+"../../../../cl_ip.gen/sources_1/ip/vio_0/hdl" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
