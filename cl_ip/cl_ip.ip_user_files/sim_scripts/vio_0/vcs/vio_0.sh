...
#
# Script generated by Vivado on Thu Jan 23 10:54:40 CST 2025
...
# script info
echo -e "vio_0.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
compile()
{
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"../../../../cl_ip.gen/sources_1/ip/vio_0/hdl/verilog" +incdir+"../../../../cl_ip.gen/sources_1/ip/vio_0/hdl" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
  ...
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../cl_ip.gen/sources_1/ip/vio_0/hdl/verilog" +incdir+"../../../../cl_ip.gen/sources_1/ip/vio_0/hdl" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
