...
#
# Script generated by Vivado on Mon Dec 08 20:26:22 UTC 2025
...
# script info
echo -e "vio_0.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
compile()
{
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"$XILINX_VIVADO/data/rsb/busdef" +incdir+"../../../../cl_ip.gen/sources_1/ip/vio_0/hdl/verilog" +incdir+"../../../../cl_ip.gen/sources_1/ip/vio_0/hdl" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
  ...
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"$XILINX_VIVADO/data/rsb/busdef" +incdir+"../../../../cl_ip.gen/sources_1/ip/vio_0/hdl/verilog" +incdir+"../../../../cl_ip.gen/sources_1/ip/vio_0/hdl" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$XILINX_VIVADO/data/rsb/busdef" +incdir+"../../../../cl_ip.gen/sources_1/ip/vio_0/hdl/verilog" +incdir+"../../../../cl_ip.gen/sources_1/ip/vio_0/hdl" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
...
Usage: vio_0.sh [-rerun]\n\
Usage: vio_0.sh [-reset_run]\n\
Usage: vio_0.sh [-clean]\n\
