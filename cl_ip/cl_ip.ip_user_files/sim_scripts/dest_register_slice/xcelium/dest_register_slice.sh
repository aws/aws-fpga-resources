...
#
# Script generated by Vivado on Mon Dec 08 20:27:59 UTC 2025
...
#                dest_register_slice.sh [-rerun]
#                dest_register_slice.sh [-reset_run]
#                dest_register_slice.sh [-clean]
...
# script info
echo -e "dest_register_slice.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
Usage: dest_register_slice.sh [-rerun]\n\
Usage: dest_register_slice.sh [-reset_run]\n\
Usage: dest_register_slice.sh [-clean]\n\
