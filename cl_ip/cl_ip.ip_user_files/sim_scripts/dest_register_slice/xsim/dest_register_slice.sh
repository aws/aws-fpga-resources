...
# set xvlog options
xvlog_opts="--incr --relax  -L smartconnect_v1_0 -L axi_vip_v1_1_22 -L xilinx_vip"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L axi_infrastructure_v1_1_0 -L axi_register_slice_v2_1_36 -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot dest_register_slice xil_defaultlib.dest_register_slice xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim dest_register_slice -key {Behavioral:sim_1:Functional:dest_register_slice} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_6722.protoinst" -protoinst "protoinst_files/cl_axi_sc_1x1.protoinst" -protoinst "protoinst_files/bd_1096.protoinst" -protoinst "protoinst_files/cl_axi_sc_2x2.protoinst" -log simulate.log
}
