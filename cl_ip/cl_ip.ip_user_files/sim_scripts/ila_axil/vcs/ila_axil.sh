...
#
# Script generated by Vivado on Mon Mar 16 15:55:23 UTC 2026
# SW Build 6299465 on Fri Nov 14 12:34:56 MST 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : ila_axil.sh
...
#
# Usage        : ila_axil.sh
#                ila_axil.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                ila_axil.sh [-rerun]
#                ila_axil.sh [-reset_run]
#                ila_axil.sh [-clean]
#                ila_axil.sh [-reset_log]
#                ila_axil.sh [-help]
#
...
#                script (type 'ila_axil.sh -help' for more information).
#
...
# script info
echo -e "ila_axil.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./ila_axil.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"$XILINX_VIVADO/data/rsb/busdef" +incdir+"../../../../cl_ip.gen/sources_1/ip/ila_axil/hdl/verilog" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
  ...
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"$XILINX_VIVADO/data/rsb/busdef" +incdir+"../../../../cl_ip.gen/sources_1/ip/ila_axil/hdl/verilog" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$XILINX_VIVADO/data/rsb/busdef" +incdir+"../../../../cl_ip.gen/sources_1/ip/ila_axil/hdl/verilog" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.ila_axil xil_defaultlib.glbl -o ila_axil_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./ila_axil_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key ila_axil_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc ila_axil_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./ila_axil.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: ila_axil.sh [-help]\n\
Usage: ila_axil.sh [-step]\n\
Usage: ila_axil.sh [-lib_map_path]\n\
Usage: ila_axil.sh [-rerun]\n\
Usage: ila_axil.sh [-reset_run]\n\
Usage: ila_axil.sh [-clean]\n\
Usage: ila_axil.sh [-reset_log]\n\
Usage: ila_axil.sh [-keep_index]\n\
Usage: ila_axil.sh [-noclean_files]\n\n\
