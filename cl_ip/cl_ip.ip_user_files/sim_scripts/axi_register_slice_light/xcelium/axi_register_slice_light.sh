...
#
# Script generated by Vivado on Thu Aug 14 14:07:53 UTC 2025
...
design_libs_elab="-libname xilinx_vip -libname xpm -libname axi_infrastructure_v1_1_0 -libname axi_register_slice_v2_1_35 -libname xil_defaultlib -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xilinx_vip xpm axi_infrastructure_v1_1_0 axi_register_slice_v2_1_35 xil_defaultlib)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "axi_register_slice_light.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
compile()
{
  ...
  xmvlog -work axi_register_slice_v2_1_35 $xmvlog_opts +incdir+"$XILINX_VIVADO/data/rsb/busdef" +incdir+"../../../../cl_ip.gen/sources_1/ip/axi_register_slice_light/hdl" +incdir+"../../../../cl_ip.gen/sources_1/ip/cl_axi_register_slice_light/hdl" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
