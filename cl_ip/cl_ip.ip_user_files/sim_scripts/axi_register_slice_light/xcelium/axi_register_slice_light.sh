...
#
# Script generated by Vivado on Mon Dec 08 20:35:54 UTC 2025
...
#                axi_register_slice_light.sh [-rerun]
#                axi_register_slice_light.sh [-reset_run]
#                axi_register_slice_light.sh [-clean]
...
design_libs_elab="-libname xilinx_vip -libname xpm -libname axi_infrastructure_v1_1_0 -libname axi_register_slice_v2_1_36 -libname xil_defaultlib -libname xilinx_vip -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xilinx_vip xpm axi_infrastructure_v1_1_0 axi_register_slice_v2_1_36 xil_defaultlib)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "axi_register_slice_light.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
compile()
{
  xmvlog -work xilinx_vip $xmvlog_opts -sv +incdir+"$XILINX_VIVADO/data/rsb/busdef" +incdir+"../../../../cl_ip.gen/sources_1/ip/axi_register_slice_light/hdl" +incdir+"../../../../cl_ip.gen/sources_1/ip/cl_axi_register_slice_light/hdl" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
  ...
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"$XILINX_VIVADO/data/rsb/busdef" +incdir+"../../../../cl_ip.gen/sources_1/ip/axi_register_slice_light/hdl" +incdir+"../../../../cl_ip.gen/sources_1/ip/cl_axi_register_slice_light/hdl" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
  ...
  xmvlog -work axi_infrastructure_v1_1_0 $xmvlog_opts +incdir+"$XILINX_VIVADO/data/rsb/busdef" +incdir+"../../../../cl_ip.gen/sources_1/ip/axi_register_slice_light/hdl" +incdir+"../../../../cl_ip.gen/sources_1/ip/cl_axi_register_slice_light/hdl" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
  "../../../ipstatic/hdl/axi_infrastructure_v1_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_register_slice_v2_1_36 $xmvlog_opts +incdir+"$XILINX_VIVADO/data/rsb/busdef" +incdir+"../../../../cl_ip.gen/sources_1/ip/axi_register_slice_light/hdl" +incdir+"../../../../cl_ip.gen/sources_1/ip/cl_axi_register_slice_light/hdl" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
  "../../../ipstatic/hdl/axi_register_slice_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"$XILINX_VIVADO/data/rsb/busdef" +incdir+"../../../../cl_ip.gen/sources_1/ip/axi_register_slice_light/hdl" +incdir+"../../../../cl_ip.gen/sources_1/ip/cl_axi_register_slice_light/hdl" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
...
Usage: axi_register_slice_light.sh [-rerun]\n\
Usage: axi_register_slice_light.sh [-reset_run]\n\
Usage: axi_register_slice_light.sh [-clean]\n\
