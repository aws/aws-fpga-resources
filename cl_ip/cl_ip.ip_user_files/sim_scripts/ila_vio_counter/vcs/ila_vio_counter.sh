...
#
# Script generated by Vivado on Mon Dec 08 20:27:23 UTC 2025
...
#                ila_vio_counter.sh [-rerun]
#                ila_vio_counter.sh [-reset_run]
#                ila_vio_counter.sh [-clean]
...
# script info
echo -e "ila_vio_counter.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
compile()
{
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"$XILINX_VIVADO/data/rsb/busdef" +incdir+"../../../../cl_ip.gen/sources_1/ip/ila_vio_counter/hdl/verilog" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
  ...
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"$XILINX_VIVADO/data/rsb/busdef" +incdir+"../../../../cl_ip.gen/sources_1/ip/ila_vio_counter/hdl/verilog" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$XILINX_VIVADO/data/rsb/busdef" +incdir+"../../../../cl_ip.gen/sources_1/ip/ila_vio_counter/hdl/verilog" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
...
Usage: ila_vio_counter.sh [-rerun]\n\
Usage: ila_vio_counter.sh [-reset_run]\n\
Usage: ila_vio_counter.sh [-clean]\n\
