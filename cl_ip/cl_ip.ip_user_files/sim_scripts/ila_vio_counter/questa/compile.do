...
vlog -work xpm -64 -incr -mfcu  -sv -L hbm_v1_0_17 "+incdir+$XILINX_VIVADO/data/rsb/busdef" "+incdir+../../../../cl_ip.gen/sources_1/ip/ila_vio_counter/hdl/verilog" "+incdir+$XILINX_VIVADO/data/xilinx_vip/include" \
