...
#
# Script generated by Vivado on Thu Jan 23 10:48:03 CST 2025
...
# set xvlog options
xvlog_opts="--incr --relax  -L axi_vip_v1_1_19 -L smartconnect_v1_0 -L hbm_v1_0_16 -L xdma_v4_1_31 -L xilinx_vip"

# script info
echo -e "cl_axi_register_slice_light.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L axi_infrastructure_v1_1_0 -L axi_register_slice_v2_1_33 -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot cl_axi_register_slice_light xil_defaultlib.cl_axi_register_slice_light xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim cl_axi_register_slice_light -key {Behavioral:sim_1:Functional:cl_axi_register_slice_light} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_6722.protoinst" -protoinst "protoinst_files/cl_axi_sc_1x1.protoinst" -protoinst "protoinst_files/bd_2e02.protoinst" -protoinst "protoinst_files/bd_a493.protoinst" -protoinst "protoinst_files/bd_9c5e.protoinst" -protoinst "protoinst_files/bd_c5ad.protoinst" -protoinst "protoinst_files/bd_1535.protoinst" -log simulate.log
}
