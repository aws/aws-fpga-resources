...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L hbm_v1_0_17 -L uvm -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot cl_hbm xil_defaultlib.cl_hbm xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim cl_hbm -key {Behavioral:sim_1:Functional:cl_hbm} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_2e02.protoinst" -protoinst "protoinst_files/bd_a493.protoinst" -protoinst "protoinst_files/bd_9c5e.protoinst" -protoinst "protoinst_files/bd_c5ad.protoinst" -protoinst "protoinst_files/bd_1535.protoinst" -log simulate.log
}
...
map_local_libs()
{
  ...
  local_libs=(xil_defaultlib hbm_v1_0_17)
