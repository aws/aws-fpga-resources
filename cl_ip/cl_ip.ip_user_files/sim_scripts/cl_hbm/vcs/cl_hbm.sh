...
design_libs=(xilinx_vip xpm xil_defaultlib hbm_v1_0_18)
...
compile()
{
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"../../../../cl_ip.gen/sources_1/ip/cl_hbm/hdl/rtl" +incdir+"../../../ipstatic/verif/model" +incdir+"$XILINX_VIVADO/data/rsb/busdef" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
  ...
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../cl_ip.gen/sources_1/ip/cl_hbm/hdl/rtl" +incdir+"../../../ipstatic/verif/model" +incdir+"$XILINX_VIVADO/data/rsb/busdef" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts -sverilog +incdir+"../../../../cl_ip.gen/sources_1/ip/cl_hbm/hdl/rtl" +incdir+"../../../ipstatic/verif/model" +incdir+"$XILINX_VIVADO/data/rsb/busdef" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
  "../../../../cl_ip.gen/sources_1/ip/cl_hbm/hdl/rtl/hbm_v1_0_18.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work hbm_v1_0_18 $vlogan_opts -sverilog +incdir+"../../../../cl_ip.gen/sources_1/ip/cl_hbm/hdl/rtl" +incdir+"../../../ipstatic/verif/model" +incdir+"$XILINX_VIVADO/data/rsb/busdef" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
