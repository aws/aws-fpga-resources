...
#
# Script generated by Vivado on Thu Aug 14 14:09:25 UTC 2025
...
design_libs_elab="-libname xilinx_vip -libname xpm -libname xil_defaultlib -libname hbm_v1_0_17 -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xilinx_vip xpm xil_defaultlib hbm_v1_0_17)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "cl_hbm.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
compile()
{
  ...
  xmvlog -work hbm_v1_0_17 $xmvlog_opts -sv +incdir+"../../../../cl_ip.gen/sources_1/ip/cl_hbm/hdl/rtl" +incdir+"../../../ipstatic/verif/model" +incdir+"$XILINX_VIVADO/data/rsb/busdef" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
