...
#
# Script generated by Vivado on Mon Dec 08 20:29:54 UTC 2025
...
design_libs_elab="-libname xilinx_vip -libname xpm -libname xil_defaultlib -libname hbm_v1_0_18 -libname xilinx_vip -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xilinx_vip xpm xil_defaultlib hbm_v1_0_18)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "cl_hbm.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
compile()
{
  xmvlog -work xilinx_vip $xmvlog_opts -sv +incdir+"../../../../cl_ip.gen/sources_1/ip/cl_hbm/hdl/rtl" +incdir+"../../../ipstatic/verif/model" +incdir+"$XILINX_VIVADO/data/rsb/busdef" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
  ...
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../cl_ip.gen/sources_1/ip/cl_hbm/hdl/rtl" +incdir+"../../../ipstatic/verif/model" +incdir+"$XILINX_VIVADO/data/rsb/busdef" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts -sv +incdir+"../../../../cl_ip.gen/sources_1/ip/cl_hbm/hdl/rtl" +incdir+"../../../ipstatic/verif/model" +incdir+"$XILINX_VIVADO/data/rsb/busdef" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
  "../../../../cl_ip.gen/sources_1/ip/cl_hbm/hdl/rtl/hbm_v1_0_18.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work hbm_v1_0_18 $xmvlog_opts -sv +incdir+"../../../../cl_ip.gen/sources_1/ip/cl_hbm/hdl/rtl" +incdir+"../../../ipstatic/verif/model" +incdir+"$XILINX_VIVADO/data/rsb/busdef" +incdir+"$XILINX_VIVADO/data/xilinx_vip/include" \
...
Usage: cl_hbm.sh [-rerun]\n\
Usage: cl_hbm.sh [-reset_run]\n\
Usage: cl_hbm.sh [-clean]\n\
