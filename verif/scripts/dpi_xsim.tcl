...
exec xsc ${HDK_COMMON_DIR}/software/src/test_null.c ${AWS_FPGA_REPO_DIR}/sdk/userspace/utils/sh_dpi_tasks.c ${HDK_COMMON_DIR}/software/src/fpga_pci_sv.c --gcc_compile_options "-I${AWS_FPGA_REPO_DIR}/sdk/userspace/include" --gcc_compile_options "-I${AWS_FPGA_REPO_DIR}/sdk/userspace/utils" --gcc_compile_options "-I${HDK_COMMON_DIR}/software/include" --gcc_compile_options "-I${HDK_COMMON_DIR}/hdk/common/software/src" --gcc_compile_options "-DVIVADO_SIM"
