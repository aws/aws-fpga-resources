...
exec gcc  ${HDK_COMMON_DIR}/software/src/test_null.c ${AWS_FPGA_REPO_DIR}/sdk/userspace/utils/sh_dpi_tasks.c ${HDK_COMMON_DIR}/software/src/fpga_pci_sv.c -fpic -shared -o ./libdpi.so -I${AWS_FPGA_REPO_DIR}/sdk/userspace/include -I${AWS_FPGA_REPO_DIR}/sdk/userspace/utils -I${HDK_COMMON_DIR}/software/include -I${HDK_COMMON_DIR}/hdk/common/software/src
